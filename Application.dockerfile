...
RUN mkdir target -p
RUN javac -Xlint:unchecked --module-path "target:/root/.m2/repository/org/junit/jupiter/junit-jupiter-engine/5.6.1/junit-jupiter-engine-5.6.1.jar" --module com.brymlee.common.composites --module-source-path src/main/java -d target
